...
const Item = ({ onDelete }: ItemProps) => {
	...
	return (
		<SwipeableRow {...{ onDelete }} {...{ height }}>
			<Box padding="m" flexDirection="row">
				<Box width={100} height={100} borderRadius="m" style={{ backgroundColor: '#BFEAF5' }} />
				...
				<Box justifyContent="center">
					<Box backgroundColor="secondary" style={{ justifyContent: 'center', alignItems: 'center', width: 24, height: 24, borderRadius: 12 }}>
