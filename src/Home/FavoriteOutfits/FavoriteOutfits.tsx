...
import { Box, Header, Footer, useTheme } from '../../components';
...
const FavoriteOutfits = ({ navigation }: HomeNavigationProps<'FavoriteOutfits'>) => {
	...
	return (
		<Box flex={1} backgroundColor="background">
			<Header title="Favorite Outfits" left={{ icon: 'menu', onPress: () => navigation.openDrawer() }} right={{ icon: 'shopping-bag', onPress: () => true }} />
			<Box flex={1}>
